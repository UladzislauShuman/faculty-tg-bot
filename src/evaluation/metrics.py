"""LLM-judge для evaluation: парсинг JSON (EvalScore) и помощники F/R/similarity к эталону."""
...
class FaithfulnessEvaluator:
  """Судья «опора ответа на контекст»: контекст + сгенерированный ответ."""
...
class RelevanceEvaluator:
  """Судья «соответствие вопросу»: вопрос пользователя + ответ бота."""
