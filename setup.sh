...
echo -e "\n${YELLOW}2/6. Сборка и запуск контейнеров...${NC}"
...
echo -e "\n${YELLOW}3/6. Загрузка LLM модели (llama3.1) внутрь Docker...${NC}"
...
echo -e "\n${YELLOW}5/6. Индексация данных (RAG)...${NC}"
...
# --- Шаг 6: Финал ---
echo -e "\n${YELLOW}6/6. Настройка завершена!${NC}"
echo -e "${GREEN}Бот запущен и готов к работе.${NC}"
echo "------------------------------------------------------------------"
echo "ВАЖНО: Для работы с Telegram нужен HTTPS туннель."
...
echo "4. Перезапустите бота командой: docker-compose restart bot"
echo "------------------------------------------------------------------"